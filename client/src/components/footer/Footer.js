      ...
      <div className="Footer-container">
        <div>
          <p>
            ...
            |{" "}
            <a className="Footer-link" onClick={() => navigate("/get-started")}>
              Get Started
            </a>{" "}
            |{" "}
            <a className="Footer-link" onClick={() => navigate("/services")}>
              Services
            </a>{" "}
            |{" "}
            <a
            ...
            |{" "}
            <a className="Footer-link" onClick={() => navigate("/locations")}>
              Locations
            </a>
          </p>
          <p>
            ...
            {/* &emsp;<a className="Footer-svg Footer-link-social" href={instagram} target="_blank" rel="noreferrer"><i className="fa fa-instagram" /></a> */}
          </p>
          <p>
            <i className="fa fa-copyright" /> Copyright 2022 DPT Physical
            Therapy & Performance
          </p>
        </div>
