...
const NavBar = () => {
  ...
  const [NavLogoWords, setNavLogoWords] = useState(
    inRange(window.innerWidth) ? NavLogoWordsSingleRow : NavLogoWordsDoubleRow
  );
  ...
  window.addEventListener("resize", () => {
    ...
    if (isInRange && !_.isEqual(NavLogoWords, NavLogoWordsSingleRow))
      setNavLogoWords(NavLogoWordsSingleRow);
    else if (!isInRange && !_.isEqual(NavLogoWords, NavLogoWordsDoubleRow))
      setNavLogoWords(NavLogoWordsDoubleRow);
  });
        ...
        <Collapse isOpen={open} navbar>
          <Nav className="ms-auto" navbar>
            <NavItem className="NavBar-item">
              <NavLink onClick={() => navigate("/about", false)}>
                <span className="NavBar-link">ABOUT</span>
              </NavLink>
            </NavItem>
            <NavItem className="NavBar-item">
              <NavLink onClick={() => navigate("/get-started", false)}>
                <span className="NavBar-link">GET STARTED</span>
              </NavLink>
            </NavItem>
            <NavItem className="NavBar-item">
              <NavLink onClick={() => navigate("/services", false)}>
                <span className="NavBar-link">SERVICES</span>
              </NavLink>
            </NavItem>
            <NavItem className="NavBar-item">
              <NavLink onClick={() => navigate("/patient-experiences", false)}>
                <span className="NavBar-link">PATIENT EXPERIENCES</span>
              </NavLink>
            </NavItem>
            <NavItem className="NavBar-item">
              <NavLink onClick={() => navigate("/locations", false)}>
                <span className="NavBar-link">LOCATIONS</span>
              </NavLink>
            </NavItem>
          </Nav>
        </Collapse>
